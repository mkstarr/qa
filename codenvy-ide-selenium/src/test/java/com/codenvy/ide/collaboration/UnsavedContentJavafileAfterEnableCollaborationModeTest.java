...
public class UnsavedContentJavafileAfterEnableCollaborationModeTest extends BaseTest {
    private static final String PROJECT = UnsavedContentJavafileAfterEnableCollaborationModeTest.class.getSimpleName();
    ...
    @Test
    public void unsavedContentJavafileTest() throws Exception {
