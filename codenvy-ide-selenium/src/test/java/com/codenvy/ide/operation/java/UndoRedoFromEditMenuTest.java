...
public class UndoRedoFromEditMenuTest extends ServicesJavaTextFuction {
    ...
    public void undoRedoFromUi() throws Exception {
        ...
        IDE.JAVAEDITOR.waitWhileJavaEditorWillContainSpecifiedText("//type1");
        IDE.JAVAEDITOR.waitWhileJavaEditorWillContainSpecifiedText("//type2");


        IDE.MENU.runCommand(MenuCommands.Edit.EDIT_MENU, MenuCommands.Edit.UNDO_TYPING);

        IDE.JAVAEDITOR.waitWhileJavaEditorWillNotContainSpecifiedText("//type2");
        IDE.MENU.runCommand(MenuCommands.Edit.EDIT_MENU, MenuCommands.Edit.REDO_TYPING);
        IDE.MENU.runCommand(MenuCommands.Edit.EDIT_MENU, MenuCommands.Edit.REDO_TYPING);
        assertTrue(IDE.JAVAEDITOR.getVisibleTextFromJavaEditor().contains("//type1 //type2"));
    }
