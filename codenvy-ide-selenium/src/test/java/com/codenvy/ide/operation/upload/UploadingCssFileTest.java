 ...
 *
 */
public class UploadingCssFileTest extends BaseTest {
    ...
    @Test
    public void uploadingCssFileTest() throws Exception {
        ...
        IDE.UPLOAD.open(MenuCommands.File.UPLOAD_FILE, FILE_PATH, MimeType.TEXT_CSS);

        IDE.EXPLORER.waitForItem(PROJECT + "/" + "Example.css");
        IDE.EXPLORER.openItem(PROJECT + "/" + "Example.css");
