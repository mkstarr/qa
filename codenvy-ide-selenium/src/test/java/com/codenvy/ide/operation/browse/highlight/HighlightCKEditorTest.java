...
public class HighlightCKEditorTest extends BaseTest {
    ...
    private static String HTML2_FILE_NAME = "newHtmlFile2.html";
    ...
    public static void setUp() {
        try {
            ...
            VirtualFileSystemUtils.createFileFromLocal(link, HTML2_FILE_NAME, MimeType.TEXT_HTML, PATH);
        } catch (IOException e) {
        }
    }
    ...
    public void testHighlightCKEdditor() throws Exception {
        ...
        IDE.EXPLORER.waitForItem(PROJECT + "/" + HTML2_FILE_NAME);
        ...
        IDE.EXPLORER.openItem(PROJECT + "/" + HTML2_FILE_NAME);
