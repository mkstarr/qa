 ...
 *
 */
public class CommitFilesWithAllChangesExceptOfNewFilesTest extends BaseTest {


    private static final String PROJECT = "simpleGitProject";
    ...
    private static final String GIT_STATUS_MESSAGE = "# On branch master\n" +
                                                     "# Untracked files:\n" +
                                                     "#   (use \"git add ...\" to include in what will be committed)\n" +
                                                     "#\n" +
                                                     "# newFile.css";

    private static final String DIFF_MESSAGE =
    ...
    private static final String PROJECT_NAME = "clonedPrj";
    ...
    @Test
    public void commitFilesWithAllChangesExceptOfNewFiles() throws Exception {
        ...
        IDE.OUTPUT.waitOpened();
        IDE.OUTPUT.waitForSubTextPresent(GIT_STATUS_MESSAGE);
        ...
        System.out.println("*******************hard-code*******************:" + DIFF_MESSAGE);
        System.out.println("-------------------getted-mess-----------------:" + IDE.GIT.getCommitDiffFromHistoryPanel());
