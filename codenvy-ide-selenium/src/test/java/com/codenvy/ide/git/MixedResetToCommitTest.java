...
public class MixedResetToCommitTest extends BaseTest {
    ...
    @Test
    public void mixedResetToCommitTest() throws Exception {
        ...
        //Open "Git > Reset..." window and reset to previous commit with reset type "mixed".
        IDE.MENU.runCommand(MenuCommands.Git.GIT, MenuCommands.Git.RESET);
        IDE.GIT.waitResetToCommitForm();
        IDE.GIT.selectMixedResetCheckbox();
