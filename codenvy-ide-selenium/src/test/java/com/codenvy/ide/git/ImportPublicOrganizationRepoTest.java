...
public class ImportPublicOrganizationRepoTest extends GitServices {

    private static final String PROJECT = "testPublicOrganizationRepo";
    ...
    @Test
    public void importPublicOrganizationRepoTest() throws Exception {
        ...
        IDE.LOADER.waitClosed();
        IDE.IMPORT_FROM_GITHUB.selectGitHubAccount("CodenvyTest");
        ...
        IDE.OUTPUT.waitForSubTextPresent("git@github.com:CodenvyTest/testPublicOrganizationRepo.git was successfully cloned.");
