...
public class ResetIndexTest extends BaseTest {
    ...
    private static final String RESET_MESSAGE = "Index successfully reset.";
    ...
    private String RESET_MESSAGE_ERROR = "[ERROR] Nothing to reset.";
    ...
    public void resetIndexTest() throws Exception {
        ...
        // Execute "Git > Reset Index..."
        IDE.MENU.runCommand(MenuCommands.Git.GIT, MenuCommands.Git.RESET_INDEX);
        IDE.GIT.waitResetIndexForm();
        IDE.GIT.clickOnResetButtonInResetIndexForm();
        IDE.OUTPUT.waitForSubTextPresent(RESET_MESSAGE_ERROR);

        IDE.MENU.runCommand(MenuCommands.Git.GIT, MenuCommands.Git.RESET_INDEX);
        IDE.GIT.waitResetIndexForm();
        IDE.GIT.waitAndSelectFileToResetInResetIndexForm("src/main/webapp/index.jsp");
        IDE.GIT.waitAndSelectFileToResetInResetIndexForm("src/main/java/helloworld/GreetingController.java");
        IDE.GIT.clickOnResetButtonInResetIndexForm();
        IDE.OUTPUT.waitOpened();
        IDE.OUTPUT.waitForSubTextPresent(RESET_MESSAGE);
