...
public class FactoryURLWorkingWithUncommittedChangestTest extends BaseTest {

    private final String REPO_INIT_MESSAGE = "[INFO] Repository was successfully initialized.";


    private final String notCommitedContentPom = "<packaging>war</packaging>";
    ...
    public void checkUncommitedBehaviorFile() throws Exception {
        ...
        IDE.FACTORY_URL.clickWithoutYourChangesBtn();
        ...
        IDE.PACKAGE_EXPLORER.openItemWithDoubleClick("pom.xml");
        IDE.EDITOR.waitActiveFile();
        IDE.EDITOR.waitContentIsPresent(notCommitedContentPom);
    }
