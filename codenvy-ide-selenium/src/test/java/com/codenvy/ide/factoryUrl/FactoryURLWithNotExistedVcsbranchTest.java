...
public class FactoryURLWithNotExistedVcsbranchTest extends BaseTest {

    private static final String PROJECT = "vcsinfoFalse";

    private static final String PARAMS = "&vcsbranch=tratatatatatata&action=openproject&projectattributes.ptype=Spring&vcsinfo=true";
    ...
    @Test
    public void factoryURLWithNotExistedVcsbranchTest() throws Exception {
        ...
        IDE.OUTPUT.waitForSubTextPresent("error: pathspec 'tratatatatatata' did not match any file(s) known to git.");
