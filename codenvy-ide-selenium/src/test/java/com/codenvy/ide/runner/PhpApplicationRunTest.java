 ...
 *
 */
public class PhpApplicationRunTest extends BaseTest {

    private static final String PROJECT = PhpApplicationRunTest.class.getSimpleName();
    ...
    @Test
    public void phpApplicationRunTest() throws Exception {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/p[text()='Hello World']")));
    }

    @Test
    public void stopPhpApplicationTest() throws Exception {
        ...
        switchToNonCurrentWindow(CURRENT_WINDOW);
        // needed for stopping application
        Thread.sleep(2000);
