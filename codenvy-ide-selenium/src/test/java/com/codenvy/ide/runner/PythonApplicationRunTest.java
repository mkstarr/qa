 ...
 *
 */
public class PythonApplicationRunTest extends BaseTest {
    private static final String PROJECT = PythonApplicationRunTest.class.getSimpleName();
    ...
    @Test
    public void pythonApplicationRunTest() throws Exception {
        ...
        IDE.CREATE_PROJECT_FROM_SCRATHC.selectProjectTemplate("Simple python application.");
    ...
    @Test
    public void stopPythonApplicationTest() throws Exception {
