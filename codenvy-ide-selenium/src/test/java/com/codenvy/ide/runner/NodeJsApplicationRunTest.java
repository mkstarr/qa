 ...
 *
 */
public class NodeJsApplicationRunTest extends BaseTest {

    private static final String PROJECT = NodeJsApplicationRunTest.class.getSimpleName();
    ...
    @Test
    public void nodeJsApplicationRunTest() throws Exception {
        ...
        IDE.CREATE_PROJECT_FROM_SCRATHC.selectNodeJsTechnology();
        IDE.CREATE_PROJECT_FROM_SCRATHC.clickNextButton();
        IDE.CREATE_PROJECT_FROM_SCRATHC.waitProjectTemplateForm();
        IDE.CREATE_PROJECT_FROM_SCRATHC.selectProjectTemplate("Simple Node.js project.");
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/h1[contains(.,'Hello from the Cloud! via:')]")));
    }

    @Test
    public void stopNodeJsApplicationTest() throws Exception {
