...
public class SpringMVCAplicationRunTest extends BaseTest {

    private static final String PROJECT = SpringApplicationRunTest.class.getSimpleName();
    ...
    @Test
    public void springMVCApplicationRunTest() throws Exception {
...
//       IDE.CREATE_PROJECT_FROM_SCRATHC.clickOnJRebelCheckbox();
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h1[contains(.,'Congratulations! Spring is running!')]")));

    }

    @Test
    public void stopSpringMVCApplicationTest() throws Exception {
