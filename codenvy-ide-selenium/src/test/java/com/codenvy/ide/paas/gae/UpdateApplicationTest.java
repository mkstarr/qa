 ...
 */
public class UpdateApplicationTest extends BaseTest {

    private final static String PROJECT_NAME = "updategae" + getCurrentTimeForProjectName();      //Application Identifier must be between 6 and 30 characters. Lowercase letters, digits, and hyphens are acceptable characters. Leading and trailing hyphens are prohibited.
    ...
    public void updateApplication() throws Exception {
        ...
        IDE.GAE.editApplication(PROJECT_NAME);
        IDE.GAE.updateApplication();
