 ...
 *
 */
public class CreateAndDeployApplicationTest extends BaseTest {
    ...
    private final static String PROJECT_NAME = CreateAndDeployApplicationTest.class.getSimpleName().toLowerCase() + "_at_" + Utils.getCurrentTimeForProjectName();
    
    
    @BeforeClass
    public static void uploadTestProject() {
        try {
    ...
    @Test
    public void createAndDeployDefaultSpringApplicationTest() throws Exception {
        // GIVEN
        Status status = new Status();
