 ...
 */
public class CreateAndDeployPhpTest extends BaseTest {

    private final static String PROJECT_NAME = "createphp" + getCurrentTimeForProjectName();      //Application Identifier must be between 6 and 30 characters. Lowercase letters, digits, and hyphens are acceptable characters. Leading and trailing hyphens are prohibited.
    ...
    @Test
    public void createPhpApplication() throws Exception {

        currentWindow = driver.getWindowHandle();
        wait = new WebDriverWait(driver, 60);

        IDE.GAE.createPhpProject(PROJECT_NAME);
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[text()='Hello World']")));
