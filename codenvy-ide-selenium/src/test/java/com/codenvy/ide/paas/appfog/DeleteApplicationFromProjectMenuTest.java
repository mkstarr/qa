 ...
 *
 */
public class DeleteApplicationFromProjectMenuTest extends BaseTest {
    ...
    private final static String PROJECT_NAME = DeleteApplicationFromProjectMenuTest.class.getSimpleName().toLowerCase() + "_at_" + Utils.getCurrentTimeForProjectName();
    ...
    public void setup() throws Exception {       
        ...
        appFog.createDefaultApplicationForCurrentProject(status.init(), PROJECT_NAME);
        status.checkSuccess();
        outputPanel.clearPanel();
        
        // create and bound mysql service to application
        appFog.createMySqlServiceAtPaaSSide(status.init(), MYSQL_SERVICE_NAME, TOKEN);        
        status.checkSuccess();
        appFog.boundServiceAtPaaSSide(status.init(), MYSQL_SERVICE_NAME, PROJECT_NAME, TOKEN);        
        status.checkSuccess();
    }
    ...
    public void deleteApplicationWithoutBoundServiceTest() throws Exception {
        ...
        // WHEN
        appFog.deleteCurrentProjectApplicationFromProjectMenu(status, PROJECT_NAME, deleteBoundServices);
