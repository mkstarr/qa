...
public class CheckProlongDialogDebugerAfterNoTest extends DebuggerServices {
    private static final String PROJECT = CheckProlongDialogDebugerAfterNoTest.class.getSimpleName();
    ...
    @Test
    public void checkAskDialogAfterProlongDebuggerSesion() throws Exception {
        runDebugApp(PROJECT);
        ...
        IDE.DEBUGER.waitExparedSessionNoBtn();
        IDE.DEBUGER.expiredNoBtnClick();
        IDE.DEBUGER.waitExparedSessionViewIsClose();
        IDE.DEBUGER.waitDebugerIsClosed();
        IDE.OUTPUT.waitForSubTextPresent("[INFO] Debugger is disconnected.");
